...
public class issue_book extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        returnDate.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 15)); // NOI18N

        issueDate.setForeground(new java.awt.Color(204, 204, 204));
        issueDate.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 15)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextFieldBookId, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextFieldStudentName, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextFieldBookName, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextFieldStudentId, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(returnDate, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int issueIdInt = random.nextInt(max - min + 1) + min;

        SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
        Date issueDateValue = issueDate.getDate();
        ...
        System.out.println("Generated Issue ID: " + issueId);
        ...
        // String issueDate = jTextFieldIssueDate.getText(); // You'll need to convert this to a Date object
        //   String returnDate = jTextFieldReturnDate.getText(); // You'll need to convert this to a Date object

        // Insert data into the database
        if (insertDataToDatabase(issueId, bookName, bookId, studentId, studentName, formattedIssueDate, formattedReturnDate, status)) {
    ...
    public void clearInputFields() {
        ...
        issueDate.setDate(null);     // Reset the date chooser
        returnDate.setDate(null);    // Reset the date chooser
    }
